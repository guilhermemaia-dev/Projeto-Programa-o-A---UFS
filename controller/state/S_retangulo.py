...
class S_Retangulo(Ferramenta):
    ...
    def mouse_ini(self, event):
        ...
        self.preview = Retangulo(self.ini_x, self.ini_y, event.x, event.y, self.model.cor_selecionada_borda, self.model.cor_selecionada_preenchimento, self.model.espessura)
